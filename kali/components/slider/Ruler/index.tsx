...
class RulerSlider extends React.Component<
  RNInfinityListSliderPropTypes,
  RNInfinityListSliderState
> {
  ...
  shouldComponentUpdate(
    ...
    if (nextProps.isDarkMode !== this.state.isDarkMode) {
      this.setState({
  ...
  renderItem = (element: Element) => (
    <Item
      ...
      index={element.index}
      style={
        this.state.isDarkMode ? darkStyles.mainBlock : lightStyles.mainBlock
      }
    ...
    <View
      style={[
        ...
        this.state.isDarkMode
          ? darkStyles.defaultThumb
          : lightStyles.defaultThumb,
