/* This file ensures that kali/ui and kali/web remains mostly clones, but with 2 differences:
...
function main() {
  ...
  const kaliWeb = removeDependency(pakWithoutIcons, "expo-av");
  console.log("@kali/web package.json:");
  console.log(kaliWeb);

  const newPackageJson = path.join(ROOT_PATH, "package.json");

  fs.writeFileSync(newPackageJson, JSON.stringify(kaliWeb, null, 2), "utf-8");

  /* This overrides Icon and AudioPlayer to be null components on the kali/web package */
